...
## Save temporary outputs - second batch 

```{r}

# # NOT NECESSARY
# # Save data and maps - delta and flipped signed maps 
# 
# if(set == "full"){
#   save(flip_sign_data,flip_sign_data_ipsl,flip_sign_data_gfdl, flip_sign_data_126,flip_sign_data_ipsl_126,flip_sign_data_gfdl_126, file = "../CMIP5vsCMIP6_data/temp_data/data_CMIPs_deltaFigures.RData")
# }else{
#   save(flip_sign_data,flip_sign_data_ipsl,flip_sign_data_gfdl,flip_sign_data_126,flip_sign_data_ipsl_126,flip_sign_data_gfdl_126, file = "../CMIP5vsCMIP6_data/temp_data/data_CMIPs_deltaFigures_reducedModelSet.RData")
# }
