...
APECOSM updated runs ? 

work on DBPM -> check senescence + fix netcdf (OK but see discussion on re-run)

# TO CHECK 

Model average - in particular agreement as it seems not to be meaningful given the other maps (agreement should be high when all model show increases or decreases). also strange white cells along the coasts for CMIP5 agreement - DONE and it seems all OK now able to reproduce Lotze exactly  
...
pt<-map_ipsl585_CMIP5$DBPM + map_ipsl585_CMIP6$DBPM + 
    ...
    map_ipsl585_CMIP5$EcoOcean + map_ipsl585_CMIP6$EcoOcean +
