...
for (i in 1:length(mod_ipsl)){
  ...
  # i = 5
  # New folder structure - see batch_run_timeSeriies.Rmd for edits 
...
# IPSL: macroecological, zoom to change! no need to flip matrix - why!???!?!? maybe fixed by Matthias - but then wht FEISTY IPSL is the only final file that still needs flipping??? 
...
if(set == "full"){
  ...
  # NEED TO re-run or MOVE from old to ned folder 
