...
data_summaries_CMIP5<-res_all
map_summaries_CMIP5<-list(avarage_CMIP5_all = avarage_CMIP5_all, sd_CMIP5_all = sd_CMIP5_all, agreement_CMIP5_all = agreement_CMIP5_all)
...
data_summaries_CMIP6<-res_all
map_summaries_CMIP6<-list(avarage_CMIP6_all = avarage_CMIP6_all, sd_CMIP6_all = sd_CMIP6_all, agreement_CMIP6_all = agreement_CMIP6_all)
save(data_ipsl_CMIP6, data_gfdl_CMIP6, map_ipsl585_CMIP6, map_gfdl585_CMIP6, data_summaries_CMIP6, map_summaries_CMIP6, file = "/Users/camillan/fishmip_outputs/CMIP6vsCMIP5_fig_temp/data_CMIP6.RData")
...
trial<-array(NA, dim=c(dim(data_summaries_CMIP5$model_average)[1],dim(data_summaries_CMIP5$model_average)[2],2))
trial[,,1]<-data_summaries_CMIP5$model_average
trial[,,2]<-data_summaries_CMIP6$model_average
...
temp<-data_summaries_CMIP5$model_average
temp1<-data_summaries_CMIP6$model_average
temp2<-temp*temp1 
...
# plot values 
# need to be consistent with delta plot (colour_scheme3)
...
map_sign_negative<-plot_FISH_MIP(data_negative, maptitle_sign_negative, c(-50, 0), colour_scheme = colour_scheme4, coltitle = "Difference \nin (%) \nchange \n", legend_ticks = 3) 
...
# plot values 
# need to be consistent with delta plot (colour_scheme3)
colour_scheme4 <- c(low = "#f4f3f9", mid = "#bab4d7",  high = "#8479b7") # google the high color to get all the gammas 
# colour_scheme4 <- c(low = "white", mid = "#d0cce4",  high = "#8479b7")
maptitle_sign_positive<-"Delta for cells that changed from a decrease in CMIP5 to an increase in CMIP6"
map_sign_positive<-plot_FISH_MIP(data_positive, maptitle_sign_positive, c(0, 50), colour_scheme = colour_scheme4, coltitle = "Difference \nin (%) \nchange \n", legend_ticks = 3)
...
pdf(paste0(save_loc,"Fig2_new.pdf"), height=10, width=15) # when 3 maps only 
pt 
dev.off()
...
pdf(paste0(save_loc,"FigS2.pdf"), height=10, width=15)
...
jpeg(paste0(save_loc,"FigS3.jpeg"), height=40, width=30, units ='in', res=300)
