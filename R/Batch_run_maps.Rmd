...
weight agreement between CMIP5 and CMIP6 by change - line 1240 and diary 
...
delta_map_all_difference<-plot_FISH_MIP(delta_map_data_all, maptitle_detla, c(-50, 50), colour_scheme = coluor_scheme3, coltitle = "Difference \nin (%) \nchange \n", legend_ticks = 5) 
...
# TO DO - weight according to degree of change or used delta as an alpha factor
