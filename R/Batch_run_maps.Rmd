...
avarage_CMIP5_all_126<-plot_FISH_MIP(model_average_all_CMIP5_126, maptitle_average, mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
sd_CMIP5_all_126<-plot_FISH_MIP(model_sd_all_CMIP5_126, maptitle_sd, sd_plot_colour_values,colour_scheme = colour_scheme1, coltitle = "Variability  \n (SD)")
agreement_CMIP5_all_126<-plot_FISH_MIP(model_agreement_all_CMIP5_126, maptitle_agreement, model_agreement_plot_colour_values ,colour_scheme = colour_scheme1, coltitle = "Model \n agreement \n (%)")

# plot average by ESMs 
avarage_CMIP5_ipsl_126<-plot_FISH_MIP(model_average_ipsl_CMIP5_126, "Mean % change RCP 2.6, 1990s to 2090s CMIP5 IPSL", mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
avarage_CMIP5_gfdl_126<-plot_FISH_MIP(model_average_gfdl_CMIP5_126, "Mean % change RCP 2.6, 1990s to 2090s CMIP5 GFDL", mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
...
# NOTE: warning for APECOSM all protocols, zoom all protocols, FEISTY all protocols are OK - see above 

for (i in 1:length(mod_ipsl)){

  filename<-paste0(mod_ipsl[i], "/ipsl-cm6a-lr/", protocol[2],"/", tolower(mod_ipsl[i]), earth[i], "historical_nat_default_",variable_to_extract[1],"_global_", output[i], "_", h_years[i], extension[i])
  
  hist<- averageFishCDF(directory, filename , variable_to_extract[1], yearmonth1[i], yearmonth2[i], average_whole_period = TRUE, CMIP =  6)
  
  filename <- paste0(mod_ipsl[i], "/ipsl-cm6a-lr/", protocol[3], "/", tolower(mod_ipsl[i]), earth[i], "ssp126_nat_default_",variable_to_extract[1],"_global_",output[i], "_",f_years[i],extension[i])
  ...
  filename <- paste0(mod_ipsl[i], "/ipsl-cm6a-lr/", protocol[3], "/", tolower(mod_ipsl[i]), earth[i], "ssp585_nat_default_",variable_to_extract[1],"_global_",output[i], "_",f_years[i],extension[i])
...
# NEW OutputData folder structure - here keep the original folder as source because these files are not ready yet. NOTE directory2! do the same for EcoOcean and DBEM
directory2<-"../CMIP5vsCMIP6_data/fishmip_outputs/marine-fishery_global_ISIMIP3b_original/"

file<-paste0(directory2,"EcoTroph/_tmp/ipsl-cm6a-lr/future/ecotroph_ipsl-cm6a-lr_nobc_ssp126_nat_default_tcb_annual_1950_2100.nc")
hist<-averageFishCDF_EcoTroph(file, time1_h, time2_h)
fut126<-averageFishCDF_EcoTroph(file, time1_f, time2_f)

# 585
file<-paste0(directory2,"EcoTroph/_tmp/ipsl-cm6a-lr/future/ecotroph_ipsl-cm6a-lr_nobc_ssp585_nat_default_tcb_annual_1950_2100.nc")
...
# hist
file<-readRDS(paste0(directory2,"EcoOcean CMIP6 RDS files/ecoocean_ipsl_nobc_historical_nosoc_default_tcb_global_monthly_1950-2005.RDS"))
hist<-averageFishCDF_EcoOcean(file, time1_h, time2_h, type = "hist")

# 126
file<-readRDS(paste0(directory2,"EcoOcean CMIP6 RDS files/ecoocean_ipsl_nobc_ssp126_nosoc_default_tcb_global_monthly_2006_2100.RDS"))
fut126<-averageFishCDF_EcoOcean(file, time1_f, time2_f, type = "fut")

# 585
file<-readRDS(paste0(directory2,"EcoOcean CMIP6 RDS files/ecoocean_ipsl_nobc_ssp585_nosoc_default_tcb_global_monthly_2006_2100.RDS"))
...
coord<-read.delim(paste0(directory2,"DBEM_RData/Lat_Lon.txt"),header = FALSE, sep = ",")
colnames(coord)<-c("grid", "lon", "lat")

# hist & 126
file<-load(paste0(directory2,"DBEM_RData/C6IPSL26F0_t2_Abd.RData"))
file<-sppfnlmap
hist<-averageFishCDF_DBEM(file, time1_h, time2_h)
fut126<-averageFishCDF_DBEM(file, time1_f, time2_f)

# 585
file<-load(paste0(directory2,"DBEM_RData/C6IPSL85F0_t2_Abd.RData"))
file<-sppfnlmap
...
mod_gfdl <- c("BOATS" ,"MACROECOLOGICAL","ZooMSS", "FEISTY") # new data structure 
...
earth<-c("_gfdl-esm4_nobasd_","_gfdl-esm4_nobasd_","_gfdl-esm4_nobasd_","_gfdl-esm4_nobasd_")
...
# warning for zoom all protocols and feisty all protocols have been checked and they are OK  

for (i in 1:length(mod_gfdl)){

  filename<-paste0(mod_gfdl[i], "/gfdl-esm4/", protocol[2],"/", tolower(mod_gfdl[i]), earth[i], "historical_nat_default_",variable_to_extract[1],"_global_", output[i], "_", h_years[i], extension[i])
  
  hist<- averageFishCDF(directory, filename , variable_to_extract[1], yearmonth1[i], yearmonth2[i], average_whole_period = TRUE, CMIP =  6)

  filename <- paste0(mod_gfdl[i], "/gfdl-esm4/", protocol[3], "/", tolower(mod_gfdl[i]), earth[i], "ssp126_nat_default_",variable_to_extract[1],"_global_",output[i], "_",f_years[i],extension[i])
  
  fut126<- averageFishCDF(directory, filename , variable_to_extract[1], yearmonth1_fut[i], yearmonth2_fut[i], average_whole_period = TRUE, CMIP = 6)
  
  filename <- paste0(mod_gfdl[i], "/gfdl-esm4/", protocol[3], "/", tolower(mod_gfdl[i]), earth[i], "ssp585_nat_default_",variable_to_extract[1],"_global_",output[i], "_",f_years[i],extension[i])
...
# hist & 126
file<-paste0(directory2,"EcoTroph/_tmp/gfdl-esm4/future/ecotroph_gfdl-esm4_nobc_ssp126_nat_default_tcb_annual_1950_2100.nc")
hist<-averageFishCDF_EcoTroph(file, time1_h, time2_h)
fut126<-averageFishCDF_EcoTroph(file, time1_f, time2_f)

# 585
file<-paste0(directory2,"EcoTroph/_tmp/gfdl-esm4/future/ecotroph_gfdl-esm4_nobc_ssp585_nat_default_tcb_annual_1950_2100.nc")
fut585<-averageFishCDF_EcoTroph(file, time1_f, time2_f)
...
# hist
file<-readRDS(paste0(directory2,"EcoOcean CMIP6 RDS files/ecoocean_gfdl_nobc_historical_nosoc_default_tcb_global_monthly_1950-2005.RDS"))
hist<-averageFishCDF_EcoOcean(file, time1_h, time2_h, type = "hist")
...
# hist & 126
file<-load(paste0(directory2,"DBEM_RData/C6GFDL26F0_t2_Abd.RData"))
file<-sppfnlmap
hist<-averageFishCDF_DBEM(file, time1_h, time2_h)
fut126<-averageFishCDF_DBEM(file, time1_f, time2_f)

# 585
file<-load(paste0(directory2,"DBEM_RData/C6GFDL85F0_t2_Abd.RData"))
file<-sppfnlmap
fut585<-averageFishCDF_DBEM(file, time1_f, time2_f)
...
# CHECK that flip matrix etc worked for each model and given the new data structure 
# IPSL: macroecological, zoom no need to flip matrix - why? maybe fixed by Matthias - but then why FEISTY IPSL is the only final file that still needs flipping? 
# GFDL: macroecological, zoom as above 
# map_ipsl585_CMIP6$APECOSM
# map_ipsl585_CMIP6$BOATS
# map_ipsl585_CMIP6$DBPM
# map_ipsl585_CMIP6$MACROECOLOGICAL
# map_ipsl585_CMIP6$FEISTY
# map_ipsl585_CMIP6$ZooMSS
# map_ipsl585_CMIP6$EcoTroph
# map_ipsl585_CMIP6$EcoOcean
# map_ipsl585_CMIP6$DBEM
# 
# map_gfdl585_CMIP6$BOATS
# map_gfdl585_CMIP6$MACROECOLOGICAL
# map_gfdl585_CMIP6$ZooMSS
# map_gfdl585_CMIP6$FEISTY
# map_gfdl585_CMIP6$EcoTroph
# map_gfdl585_CMIP6$EcoOcean
# map_gfdl585_CMIP6$DBEM
...
# map_ipsl126_CMIP6$APECOSM
# map_ipsl126_CMIP6$BOATS
# map_ipsl126_CMIP6$DBPM
# map_ipsl126_CMIP6$MACROECOLOGICAL
# map_ipsl126_CMIP6$FEISTY
# map_ipsl126_CMIP6$ZooMSS
# map_ipsl126_CMIP6$EcoTroph
# map_ipsl126_CMIP6$EcoOcean
# map_ipsl126_CMIP6$DBEM
# 
# map_gfdl126_CMIP6$BOATS
# map_gfdl126_CMIP6$MACROECOLOGICAL
# map_gfdl126_CMIP6$ZooMSS
# map_gfdl126_CMIP6$FEISTY
# map_gfdl126_CMIP6$EcoTroph
# map_gfdl126_CMIP6$EcoOcean
# map_gfdl126_CMIP6$DBEM
...
# Plot the model average and standard deviation
avarage_CMIP6_all_126<-plot_FISH_MIP(model_average_all_CMIP6_126, maptitle_average, mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
sd_CMIP6_all_126<-plot_FISH_MIP(model_sd_all_CMIP6_126, maptitle_sd, sd_plot_colour_values,colour_scheme = colour_scheme1, coltitle = "Variability  \n (SD)")
agreement_CMIP6_all_126<-plot_FISH_MIP(model_agreement_all_CMIP6_126, maptitle_agreement, model_agreement_plot_colour_values ,colour_scheme = colour_scheme1, coltitle = "Model \n agreement \n (%)")

# plot average by ESM 
avarage_CMIP6_ipsl_126<-plot_FISH_MIP(model_average_ipsl_CMIP6_126, "Mean % change RCP 2.6, 1990s to 2090s CMIP6 IPSL", mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
avarage_CMIP6_gfdl_126<-plot_FISH_MIP(model_average_gfdl_CMIP6_126, "Mean % change RCP 2.6, 1990s to 2090s CMIP6 GFDL", mean_plot_colour_values, colour_scheme = colour_scheme2, coltitle = "Biomass \n change \n (%)")
...
if(set == "full"){
  ...
  # file structure from OutputData folder - NOTE TEST ON FULL SET ONLY - if that works all is good 
  save(data_ipsl_CMIP6, data_gfdl_CMIP6, map_ipsl585_CMIP6, map_gfdl585_CMIP6, map_ipsl126_CMIP6, map_gfdl126_CMIP6, data_summaries_CMIP6, map_summaries_CMIP6, file = "../CMIP5vsCMIP6_data/temp_data/data_CMIP6.RData")
...
a<-sum(!is.na(data_summaries_CMIP6$res_all$model_average*data_summaries_CMIP5$res_all$model_average)) # sum the number of cells that are not NA neither in CMIP5 nor CMIP6
b<-sum(!is.na(flip_sign_data$data_negative)) # sum the number of cells that are not NA - i.e. the ones with negative changes
...
# % of cell that change
a<-sum(!is.na(data_summaries_CMIP5$res_ipsl$model_average*data_summaries_CMIP6$res_ipsl$model_average))
...
# % of cell that change
a<-sum(!is.na(data_summaries_CMIP5$res_gfdl$model_average*data_summaries_CMIP6$res_gfdl$model_average))
...
a <- map_summaries_CMIP5$avarage_CMIP5_all + ggtitle("a) CMIP5 RCP8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[1])) + theme_opts_new 
b <- map_summaries_CMIP6$avarage_CMIP6_all + ggtitle("b) CMIP6 SSP5-8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[1])) + theme_opts_new 
c <- delta_map_all_difference + ggtitle("c) Change between CMIPs") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
d<- map_sign_neutral + ggtitle("d) Same direction of change between CMIPs") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
e <- map_sign_positive + ggtitle("e) Shift to positive change") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
f <- map_sign_negative + ggtitle("f) Shift to negative change") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
...
pdf(paste0(save_loc,name), height=5.5, width=7.086) # width can only be 180 mm if the fig is a 2 column one (7,086 inch)
pt
dev.off()

### FIG S12 & S18 - 2.6 scenario ####

a126 <- map_summaries_CMIP5$avarage_CMIP5_all_126 + ggtitle("a) CMIP5 RCP2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[1])) + theme_opts_new
b126 <- map_summaries_CMIP6$avarage_CMIP6_all_126 + ggtitle("b) CMIP6 SSP1-2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[1])) + theme_opts_new 
c126 <- delta_map_all_difference_126 + ggtitle("c) Change between CMIPs") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new
d126 <- map_sign_neutral_126 + ggtitle("d) Same direction of change between CMIPs") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
e126 <- map_sign_positive_126 + ggtitle("e) Shift to positive change") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
f126 <- map_sign_negative_126 + ggtitle("f) Shift to negative change") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit[2])) + theme_opts_new 
...
a2_noleg = a2 + theme(legend.position = "none")
c_noleg = c + theme(legend.position = "none")
e_noleg = e + theme(legend.position = "none")
g_noleg = g + theme(legend.position = "none")
i_noleg = i + theme(legend.position = "none")
k_noleg = k + theme(legend.position = "none")
...
if(set == "full"){name = "FigS5_lessLegend.pdf"}else{name = "FigS?_lessLegend.pdf"}
...
a2126_noleg = a2126 + theme(legend.position = "none")
c126_noleg = c126 + theme(legend.position = "none")
e126_noleg = e126 + theme(legend.position = "none")
g126_noleg = g126 + theme(legend.position = "none")
i126_noleg = i126 + theme(legend.position = "none")
k126_noleg = k126 + theme(legend.position = "none")

pt<-a2126_noleg + b2126 + 
  c126_noleg + d126 +
  e126_noleg + f126 +
  g126_noleg + h126 + 
  i126_noleg + j126 + 
...
if(set == "full"){name = "FigS13_lessLegend.pdf"}else{name = "FigS19_lessLegend.pdf"}
...
c<-map_summaries_CMIP5$sd_CMIP5_all +  ggtitle("c) CMIP5 RCP8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[1])) + theme_opts_new 
d<-map_summaries_CMIP6$sd_CMIP6_all +  ggtitle("d) CMIP6 SSP5-8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[1])) + theme_opts_new 
e<-map_summaries_CMIP5$agreement_CMIP5_all + ggtitle("e) CMIP5 RCP8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[2])) + theme_opts_new 
f<-map_summaries_CMIP6$agreement_CMIP6_all + ggtitle("f) CMIP6 SSP5-8.5") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[2])) + theme_opts_new 

pt<-a + b + # SAME AS FIG 5 # ### WRONG! this come out as BOATS in a previous run - fixed 
    c + d +  
    e + f +  
    plot_layout(design = layout)
...
if(set == "full"){name = "FigS6_lessLegend.pdf"}else{name = "FigS10_lessLegend.pdf"}
...
c126<-map_summaries_CMIP5$sd_CMIP5_all_126 +  ggtitle("c) CMIP5 RCP2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[1])) + theme_opts_new
d126<-map_summaries_CMIP6$sd_CMIP6_all_126 +  ggtitle("d) CMIP6 SSP1-2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[1])) + theme_opts_new
e126<-map_summaries_CMIP5$agreement_CMIP5_all_126 + ggtitle("e) CMIP5 RCP2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[2])) + theme_opts_new
f126<-map_summaries_CMIP6$agreement_CMIP6_all_126 + ggtitle("f) CMIP6 SSP1-2.6") + guides(fill = guide_colourbar(barwidth = 0.5, barheight = 3, title = tit2[2])) + theme_opts_new

pt<-a126 + b126 + # same as Fig S12
    c126 + d126 +  
    e126 + f126 +  
    plot_layout(design = layout)
...
a126_noleg = a126 + theme(legend.position = "none")
c126_noleg = c126 + theme(legend.position = "none")
e126_noleg = e126 + theme(legend.position = "none")
...
if(set == "full"){name = "FigS16_lessLegend.pdf"}else{name = "FigS20_lessLegend.pdf"}
