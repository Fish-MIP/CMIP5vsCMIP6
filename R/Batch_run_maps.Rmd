...
model_stat<-function(data){
  ...
  #### CHECK NA + NA = 0 not NA !!!! see crop maps. this could explain some of the differences between Lotze and  your plots in both maps and trends in changes as you then avarage values across all cells
...
save(model_average_all_CMIP5, file = "/Users/nov017/fishmip_outputs/CMIP6vsCMIP5_fig_temp/model_average_all_CMIP5.RData")
