...
# need to consider the following code when changing the model set for CMIP6 only
...
save(data_ipsl_CMIP6, data_gfdl_CMIP6, map_ipsl585_CMIP6, map_gfdl585_CMIP6, data_summaries_CMIP6, map_summaries_CMIP6, file = "/Users/camillan/fishmip_outputs/CMIP6vsCMIP5_fig_temp/data_CMIP6_noApecosm_reducedModelSet.RData")
...
rm(list=ls())
# 2 datasets: 1 complete (ALL MODELS), and 1 reduced (LOTZE set + ZOOM but - apecosm because not available in cmip6)  
...
save(delta_average_all, delta_average_ipsl, delta_average_gfdl,flip_sign_data,flip_sign_data_ipsl,flip_sign_data_gfdl, file = "/Users/camillan/fishmip_outputs/CMIP6vsCMIP5_fig_temp/data_CMIPs_deltaFigures_reducedModelSet.RData")
...
c <- delta_map_all_difference + ggtitle("C) Delta change") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
d <- map_sign_positive + ggtitle("D) Positive change") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
e <- map_sign_negative + ggtitle("E) Negative change") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))

pt<-a + b + c + d + e + plot_layout(design = layout)

# pdf(paste0(save_loc,"Fig2_new_noApecosm.pdf"), height=10, width=15) # old name 
# pdf(paste0(save_loc,"FigS5_noApecosm.pdf"), height=10, width=15) # CONSIDER ALL MODELS
# pt
# dev.off()

pdf(paste0(save_loc,"Fig5_noApecosm.pdf"), height=10, width=15) # CONSIDER LOTZE SET + ZOOM
pt
dev.off()

## ALL MODELS? this is fig S6 and S10 but there are 2 options for eahc here 
...
e <- delta_map_ipsl_difference + ggtitle("E) Delta change IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
f <- delta_map_gfdl_difference + ggtitle("F) Delta change GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
g <- map_sign_positive_ipsl + ggtitle("G) Positive change IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
h <- map_sign_negative_ipsl + ggtitle("H) Negative change IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
i <- map_sign_positive_gfdl + ggtitle("I) Positive change GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
l <- map_sign_negative_gfdl + ggtitle("H) Negative change GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
# pdf(paste0(save_loc,"FigS6_noApecosm.pdf"), height=20, width=15)
# pt
# dev.off()

pdf(paste0(save_loc,"FigS6_noApecosm_subset.pdf"), height=20, width=15)
pt
dev.off()
...
# better size = 12 and no facet bold 
...
# pdf(paste0(save_loc,"FigS10_noApecosm.pdf"), height=10, width=15)
# pt
# dev.off()

pdf(paste0(save_loc,"FigS10_noApecosm_subset.pdf"), height=10, width=15)
pt
dev.off()
...
c<-map_ipsl585_CMIP5$BOATS +  ggtitle("A) BOATS CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
d<-map_ipsl585_CMIP6$BOATS +  ggtitle("B) BOATS CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
e<-map_ipsl585_CMIP5$DBEM + ggtitle("C) DBEM CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
f<-map_ipsl585_CMIP6$DBEM + ggtitle("D) DBEM CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
g <- map_ipsl585_CMIP5$DBPM + ggtitle("E) DBPM CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
h <- map_ipsl585_CMIP6$DBPM + ggtitle("F) DBPM CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
i <- map_ipsl585_CMIP5$EcoOcean + ggtitle("G) EcoOcean CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
l <- map_ipsl585_CMIP6$EcoOcean + ggtitle("H) EcoOcean CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
m <- map_ipsl585_CMIP6$EcoTroph + ggtitle("I) EcoTroph CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
n <- map_ipsl585_CMIP5$MACROECOLOGICAL + ggtitle("J) MACROECOLOGICAL CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
o <- map_ipsl585_CMIP6$MACROECOLOGICAL + ggtitle("K) MACROECOLOGICAL CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
p <- map_ipsl585_CMIP6$FEISTY  + ggtitle("L) FEISTY CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
q<- map_ipsl585_CMIP5$ZooMSS +ggtitle("M) ZooMSS CMIP5 RCP8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
r <- map_ipsl585_CMIP6$ZooMSS  +ggtitle("N) ZooMSS CMIP6 SSP5-8.5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
# jpeg(paste0(save_loc,"FigS3_noApecosm_ipsl.jpeg"), height=40, width=30, units ='in', res=300) # old name
jpeg(paste0(save_loc,"FigS8_noApecosm.jpeg"), height=40, width=30, units ='in', res=300)
...
# jpeg(paste0(save_loc,"FigS3_noApecosm_gfdl.jpeg"), height=40, width=30, units ='in', res=300) # old name
jpeg(paste0(save_loc,"FigS7_noApecosm.jpeg"), height=35, width=30, units ='in', res=300)
pt
dev.off()
