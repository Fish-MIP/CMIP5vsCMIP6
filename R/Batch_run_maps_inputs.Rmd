...
pt<- map_summaries_CMIP6$map_average_change_CMIP6$to + delta_map$to +
  map_summaries_CMIP6$map_average_change_CMIP6$pp + delta_map$pp +
  plot_layout(design = layout)

pdf(paste0(save_loc,"Fig1.pdf"), height=10, width=15)
pt 
dev.off()
...
pt<-map_summaries_CMIP5$map_average_change_CMIP5$to + map_summaries_CMIP6$map_average_change_CMIP6$to + delta_map$to +
  map_summaries_CMIP5$map_average_change_CMIP5$pp + map_summaries_CMIP6$map_average_change_CMIP6$pp + delta_map$pp +
  map_summaries_CMIP5$map_average_change_CMIP5$phy + map_summaries_CMIP6$map_average_change_CMIP6$phy + delta_map$phy +
  map_summaries_CMIP5$map_average_change_CMIP5$zoo + map_summaries_CMIP6$map_average_change_CMIP6$zoo + delta_map$zoo +
  plot_layout(design = layout)

pdf(paste0(save_loc,"Fig1_complete.pdf"), height=15, width=20)
pt 
dev.off()
...
# FIG 1B IPSL and GFDL - can do with map_ipsl_value_2100_CMIP5 and map_ipsl_change_CMIP5 for FIG 1 (although you need to calculate delta too... ) and FIG 1B 2100
layout <- "
AB
CD
EF
