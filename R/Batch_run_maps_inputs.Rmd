...
for(i in 1:length(data_summaries_CMIP6$data_average_change_CMIP6)){
  ...
  # THIS IS STRANGE!!! for temp results are different if I consider % change or C change !!! why??? 
...
a<-map_summaries_CMIP6$map_average_change_CMIP6$to +  ggtitle("C) SST CMIP6") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
b<-delta_map$to +  ggtitle("D) SST change between CMIPs") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
f<-map_summaries_CMIP6$map_average_change_CMIP6$phy + ggtitle("H) Phytoplankton carbon CMIP5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
i<-map_summaries_CMIP6$map_average_change_CMIP6$zoo + ggtitle("K) Zooplankton carbon CMIP5") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
pdf(paste0(save_loc,"FigS3.pdf"), height=15, width=20)
pt 
dev.off()
...
# Fig 1 and 1B split by earth system models 
...
# right column (first raw for all section) is the left colummn of S3... 
...
c1<-map_summaries_CMIP5$map_average_change_CMIP5$pp + ggtitle("D) NPP CMIP5 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
c<-map_ipsl_change_CMIP5$pp + ggtitle("E) NPP CMIP5 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
d<-map_gfdl_change_CMIP5$pp + ggtitle("F) NPP CMIP5 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))

e<-map_summaries_CMIP5$map_average_change_CMIP5$phy +  ggtitle("G) Phytoplankton carbon CMIP5 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
f<-map_ipsl_change_CMIP5$phy + ggtitle("H) Phytoplankton carbon CMIP5 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
g<-map_gfdl_change_CMIP5$phy + ggtitle("I) Phytoplankton carbon CMIP5 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))

h<-map_summaries_CMIP5$map_average_change_CMIP5$zoo +  ggtitle("J) Zooplankton carbon CMIP5 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
i<- map_ipsl_change_CMIP5$zoo + ggtitle("K) Zooplankton carbon CMIP5 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
l<-map_gfdl_change_CMIP5$zoo+ ggtitle("L) Zooplankton carbon CMIP5 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
...
# right column (first raw for all section) is the middle colummn of S3... 
...
c1<-map_summaries_CMIP6$map_average_change_CMIP6$pp + ggtitle("D) NPP CMIP6 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
c<-map_ipsl_change_CMIP6$pp + ggtitle("E) NPP CMIP6 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
d<-map_gfdl_change_CMIP6$pp + ggtitle("F) NPP CMIP6 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))

e<-map_summaries_CMIP6$map_average_change_CMIP6$phy +  ggtitle("G) Phytoplankton carbon CMIP6 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
f<-map_ipsl_change_CMIP6$phy + ggtitle("H) Phytoplankton carbon CMIP6 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
g<-map_gfdl_change_CMIP6$phy + ggtitle("I) Phytoplankton carbon CMIP6 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))

h<-map_summaries_CMIP6$map_average_change_CMIP6$zoo +  ggtitle("J) Zooplankton carbon CMIP6 ESMs average") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
i<- map_ipsl_change_CMIP6$zoo + ggtitle("K) Zooplankton carbon CMIP6 IPSL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
l<-map_gfdl_change_CMIP6$zoo+ ggtitle("L) Zooplankton carbon CMIP6 GFDL") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
