...
save(data_ipsl_CMIP5, data_gfdl_CMIP5, file = "../CMIP5vsCMIP6_data/temp_data/data_trends_inputs_CMIP5_weigthedMean2.RData")
...
save(data_ipsl_CMIP6, data_gfdl_CMIP6, file = "../CMIP5vsCMIP6_data/temp_data/data_trends_inputs_CMIP6_weigthedMean2.RData")
...
pdf(paste0(save_loc,"Fig1_weigthedMean3.pdf"), height=8.858, width=7.086) # width can only be 180 mm if the fig spans 2 columns (7,086 inch)
plot
dev.off()
