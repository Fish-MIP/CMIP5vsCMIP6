...
# FIG ?: trends in temp and PP *skyp*  
...
# FIG 1: trends in temperature and pp by earth system model and protocol
...
to_cmip5<-ggplot(filter(all_notMean$to, cmip==5), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=1) +
  geom_vline(xintercept = 2005.5, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
...
to_cmip6<-ggplot(filter(all_notMean$to, cmip==6), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=1) +
  geom_vline(xintercept = 2015, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
...
pp_cmip5<-ggplot(filter(all_notMean$pp, cmip==5), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=1) +
  geom_vline(xintercept = 2005.5, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
  scale_y_continuous(limits = c(-15, 15), breaks = pretty(seq(15, -15), n = 10), name = "Change in net primary production (%)") +
  scale_x_continuous(limits = c(1970, 2100), breaks = pretty(all$to$year, n = 10), name = NULL)+
  scale_color_manual(values = c("black","blue" ,"red"), name = NULL, labels = c("Historical", "RCP2.6", "RCP8.6"))+
  scale_fill_manual(values = c("black","blue" ,"red"), name = NULL, labels = c("Historical", "RCP2.6", "RCP8.6"))+
  scale_linetype_manual(values = c("solid","dotdash"),name = "Earth System Models", labels =c("GFDL-ESM2M","IPSL-CM5A-LR"))+
  theme_bw()+
...
pp_cmip6<-ggplot(filter(all_notMean$pp, cmip==6), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=0.7) +
  geom_vline(xintercept = 2015, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
  scale_y_continuous(limits = c(-15, 15), breaks = pretty(seq(15, -15), n = 10), name = "Change in net primary production (%)") +
  scale_x_continuous(limits = c(1970, 2100), breaks = pretty(all$to$year, n = 10), name = NULL)+
  scale_color_manual(values = c("black","blue" ,"red"), name = NULL, labels = c("Historical", "SSP1-2.6", "SSP5-8.5"))+
  scale_fill_manual(values = c("black","blue" ,"red"), name = NULL, labels = c("Historical", "SSP1-2.6", "SSP5-8.5"))+
  scale_linetype_manual(values = c("solid","dotdash"),name = "Earth System Models", labels =c("GFDL-ESM4","IPSL-CM6A-LR"))+
  theme_bw()+
  theme(text = element_text(size=14),
        axis.title.y = element_text(vjust=0.4, size = 20),
...
ph_cmip5<-ggplot(filter(all_notMean$phy, cmip==5), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=1) +
  geom_vline(xintercept = 2005.5, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
...
ph_cmip6<-ggplot(filter(all_notMean$phy, cmip==6), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=0.7) +
  geom_vline(xintercept = 2015, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
...
zoo_cmip5<-ggplot(filter(all_notMean$zoo, cmip==5), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=1) +
  geom_vline(xintercept = 2005.5, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
...
zoo_cmip6<-ggplot(filter(all_notMean$zoo, cmip==6), aes(x=year, y = tcbChange,  color = protocol, linetype = earth))+ 
  annotate("rect", xmin = 1990, xmax = 2000, ymin = -Inf, ymax = Inf, alpha = .2)+
  geom_line(size=0.7) +
  geom_vline(xintercept = 2015, color = "grey60", size = 2)+
  geom_hline(yintercept = 0, color = "grey60", size = 1)+
