...
save(data_ipsl_CMIP6, data_gfdl_CMIP6, file = "/Users/camillan/fishmip_outputs/CMIP6vsCMIP5_fig_temp/data_trends_CMIP6_noApecosm.RData")
# no_Apecosm version for this script should include: updated Feisty, DBPM for GFDL and updated Zoom (when all available). You are removing apecosm below and you will add it back when you'll get the corrected runs
...
load("/Users/camillan/fishmip_outputs/CMIP6vsCMIP5_fig_temp/data_trends_CMIP6_noApecosm.RData")
...
# pdf(paste0(save_loc,"FigS4_noApecosm.pdf"), height=6.5, width=15) # CONSIDER ALL MODELS
# plot
# dev.off()

pdf(paste0(save_loc,"Fig3_noApecosm.pdf"), height=6.5, width=15) # CONSIDER LOTZE model set
plot
dev.off()
...
# FIG 4 or S9: trends in tcb by model *obsolete skip*
...
#   scale_color_manual(values = c("blue", "lightblue","black", "pink","purple","brown","green","orange"), name = "Models")+ # no apecosm 
...
# pdf(paste0(save_loc,"FigS9_noApecosm.pdf"), height=6.5, width=15) # CONSIDER ALL MODELS 
# plot 
# dev.off()
# 
# # pdf(paste0(save_loc,"Fig4_noApecosm.pdf"), height=6.5, width=15) # CONSIDER LOTZE MODEL SET 
# # plot 
# # dev.off()
...
a2<-a2 + ggtitle("A) CMIP5 GFDL-ESM2M") + theme(plot.title = element_text(size = 16, face = "bold", hjust = 0))
b2<-b2 + ggtitle("B) CMIP6 GFDL-ESM4") + theme(plot.title = element_text(size = 16, face = "bold",hjust = 0), axis.title.y = element_blank()) # legend.position = "none"

plot<-a1 + b1 + a2 + b2 + 
  plot_layout(design = layout)

# # pdf(paste0(save_loc,"Fig3B_noApecosm.pdf"), height=6.5, width=15) # old name
# pdf(paste0(save_loc,"FigS9_noApecosm.pdf"), height=12, width=15) # CONSIDER ALL MODELS
# plot
# dev.off()

pdf(paste0(save_loc,"Fig4_noApecosm.pdf"), height=12, width=15) # CONSIDER LOTZE MODEL SET
plot
dev.off()
