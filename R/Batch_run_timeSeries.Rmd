...
save(data_ipsl_CMIP5, data_gfdl_CMIP5, file = "../CMIP5vsCMIP6_data/temp_data/data_trends_CMIP5_weigthedMean.RData")
...
for (i in 1:length(mod_ipsl)){
  ...
  # APECOSM: 
  # delete _tmp, change file name in details above 
  # BOATS
  # delete _tmp, change file name in details above, change date reference (HelperScript line ~120)
  # DBPM 
  # delete _tmp
  # MACROECOLOGICAL 
  # delete _tmp, change file name in details above X 2
  # FEISTY 
  # delete _tmp
  # ZooMSS
  # delete _tmp
...
save(data_ipsl_CMIP6, data_gfdl_CMIP6, file = "../CMIP5vsCMIP6_data/temp_data/data_trends_CMIP6_weigthedMean.RData")
...
load("../CMIP5vsCMIP6_data/temp_data/data_trends_CMIP5_weigthedMean.RData")
load("../CMIP5vsCMIP6_data/temp_data/data_trends_CMIP6_weigthedMean.RData")
...
if(set == "full"){name = "Fig3_weigthedMean.pdf"}else{name = "FigS7_weigthedMean.pdf"}
...
if(set == "full"){name = "Fig4_weigthedMean.pdf"}else{name = "FigS8_weigthedMean.pdf"}
...
if(set == "full"){name = "FigS11_weigthedMean.pdf"}else{name = "FigS17_weigthedMean.pdf"}
